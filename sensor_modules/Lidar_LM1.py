...
class Lidar_LM1:
    ...
    def check_dirty(self):
        ...
        while True:
            ...
            if dirty_percentage is not None:
                ...
                with open("/home/karol/Desktop/repos/SLAM/data/dirty_percentage.txt", "a") as file:
    ...
    def open_file(self):
        open("/home/karol/Desktop/repos/SLAM/data/dirty_percentage.txt", "w").close()
        open("/home/karol/Desktop/repos/SLAM/data/imu_data.txt", "w").close()
        open("/home/karol/Desktop/repos/SLAM/data/cloud_data.txt", "w").close()
        ...
        while True:
            ...
            if result == "IMU":
                ...
                if imu_data:
                    ...
                    with open("/home/karol/Desktop/repos/SLAM/data/imu_data.txt", "w") as imu_file:
                ...
                with open("/home/karol/Desktop/repos/SLAM/data/cloud_data.txt", "w") as cloud_file:
