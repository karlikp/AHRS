...
def calc_input_with_imu(imu_data):
    linear_velocity = imu_data["linear_velocity"]
    angular_velocity = imu_data["angular_velocity"]
    u = np.array([linear_velocity, angular_velocity]).reshape(2, 1)
    return u



# def observation_from_lidar(lidar_data):
#     # lidar_data: np.array([[distance1, angle1], [distance2, angle2], ...])
#     landmarks = []
#     for distance, angle in lidar_data:
#         if distance <= MAX_RANGE:
#             landmarks.append([distance, angle])
